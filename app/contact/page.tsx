      ...
      <section className="section">
        <div className="mx-auto max-w-6xl container-px grid gap-10 lg:grid-cols-2">
          ...
          <div className="space-y-6">
            ...
            {/* === Thailand branch office — Asialink Co., LTD. (managed by Andrey Chabanov) === */}
            <div className="overflow-hidden rounded-xl border-2 border-sky-200 bg-gradient-to-br from-sky-50 via-white to-amber-50 shadow-sm">
              <div className="border-b border-sky-100 bg-white/60 px-5 py-3">
                <div className="flex items-center gap-2">
                  {/* eslint-disable-next-line @next/next/no-img-element */}
                  <img
                    src="https://flagcdn.com/w40/th.png"
                    alt="Thailand flag"
                    className="h-4 w-6 rounded-sm object-cover ring-1 ring-sky-200"
                  />
                  <div className="text-xs font-bold uppercase tracking-wider text-sky-700">
                    {t("branch.thailand.label")}
                  </div>
                </div>
              </div>
              <div className="p-5">
                <div className="flex items-start gap-4">
                  <div className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-sky-100 text-xl ring-2 ring-sky-200">
                    🏢
                  </div>
                  <div className="min-w-0 flex-1">
                    <div className="text-lg font-bold text-slate-900">{t("branch.thailand.company")}</div>
                    <div className="text-sm font-semibold text-sky-700">
                      {t("branch.thailand.manager")} <span className="font-normal text-slate-500">— {t("branch.thailand.managerRole")}</span>
                    </div>
                    <div className="mt-3 space-y-2 text-sm">
                      <div className="flex items-start gap-2">
                        <span className="mt-0.5 text-base">📍</span>
                        <span className="text-slate-700">{t("branch.thailand.address")}</span>
                      </div>
                      <a
                    ...
                    <p className="mt-3 text-xs leading-relaxed text-slate-500">{t("branch.thailand.note")}</p>
                  </div>
                </div>
              </div>
            </div>
